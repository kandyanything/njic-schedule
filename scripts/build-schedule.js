// Build data/schedule.json - every North Jersey Interscholastic Conference game we can reach,
...
//
// Covers all 36 member schools on DigitalSports (ds-schools.json).
...
// No NJIC schools use iCal feeds - all 35 are on DigitalSports.
...
// No NJIC schools are on ArbiterLive - all 35 use DigitalSports.
...
async function main() {
    ...
    fs.writeFileSync(OUT, JSON.stringify({
        _comment: 'Generated by scripts/build-schedule.js - do not edit by hand. Covers all 36 NJIC member schools on DigitalSports. Games only - practices are filtered out. Sorted by date then start time, de-duplicated so a fixture listed by both schools appears once. Cancelled games are kept and carry status.',
        generated: new Date().toISOString(),
        range: { start, end },
        sources: report,
        coverage: { schoolsFetched: report.length, schoolsInConference: 36, complete: report.length >= 36 },
